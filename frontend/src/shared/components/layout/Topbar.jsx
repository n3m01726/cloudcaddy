...
const info = routeInfo[location.pathname] || { title: 'Dashboard', description: '' };
  ...
  return (
    <header className="h-16 bg-white/80 backdrop-blur-lg border-b border-t border-gray-200 
      flex items-center justify-between px-6 relative z-[60]">
...
{showUserMenu && (
  <>
    ...
    {/* Menu */}
    <div className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-2xl border border-gray-200 z-50">
      {/* User info */}
